...
//#define DPS310_DEVICE_ID                0x77
#define DPS310_DEVICE_ID		0x76
...
static const struct DeviceInfo devices[] = {
    { DPS310_DEVICE_ID, "dps310" },
};
...
static int dps310_rx(I2CSlave *i2c)
{
...
static int dps310_init(I2CSlave *i2c)
{
    DPS310State *s = DPS310(i2c);
...
static void dps310_initfn(Object *obj)
{
    ...
    object_property_add(obj, "pressure", "int",
                        dps310_get_pressure,
                        dps310_set_pressure, NULL, NULL, NULL);
}
